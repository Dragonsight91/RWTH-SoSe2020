/** Generischer Datentyp fuer lineare Listen von vergleichbaren Objekten
 * @see Element
 * @see Vergleichbar
...
public class Liste <T extends Vergleichbar> {
     ...
     *           es ein solches gibt. Sonst wird null zurueckgegeben.
     */
    private static <S extends Vergleichbar> Element <S> suche (S wert, Element <S> kopf) {
     ...
     */
    private static <S extends Vergleichbar> String durchlaufe (Element <S> kopf) {
     ...
     */
    private static <S extends Vergleichbar> String durchlaufeRueckwaerts (Element <S> kopf) {
     ...
     */
    public void fuegeVorneEin (T wert) {
     ...
     */
    private static <S extends Vergleichbar> Element <S> loesche (S wert, Element <S> element) {
